...
Optional flags. Toggles are off by default; the mode flags default to the value marked below. Unset `CHECKPOINTER` means Postgres whenever `DATABASE_URL` is set.
