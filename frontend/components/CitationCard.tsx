...
export function CitationCard({ citation }: { citation: Citation }) {
  return (
    <a
      ...
      className="inline-flex items-center gap-2 rounded-sm border border-(--bronze) bg-(--bronze-tint) px-3 py-1.5 transition-colors duration-150 hover:bg-(--bronze-soft)"
    >
